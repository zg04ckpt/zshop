...
import '../../styles/pages/ManageCate.css';
...
import { CategoryListItemDTO } from "../../types/book";
import { showErrorToast } from "../../utils";
import { createCategory, deleteCategory, getCategories, updateCategory } from "../../api";
import { convertDateToTimeSpan, defaultImageUrl, scrollToTop } from "../../utils/helper";
...
export const ManageCate = () => {
    ...
    const handleRemoveCategory = async (id: number) => {
        appContext?.showConfirmDialog({
            ...
            onConfirm: async () => {
                dispatch(startLoadingStatus());
                if ((await deleteCategory(id)).isSuccess) {
                    load();
                }
                dispatch(endLoadingStatus());
            },
