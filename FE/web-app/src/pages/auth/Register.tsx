...
import { loginWithGoogle, logout, register } from "../../api";
...
export const Register = () => {
    ...
    const handleRegisterAction = async () => {
        ...
        if (registerResult.isSuccess) {
            ...
            showErrorToast(registerResult.message || "Đăng kí thất bại");
        }
            ...
            <div className="row mt-4">
                ...
                <div className="card col-6 card-body rounded-0 mt-3">
                    ...
                    <div className="d-flex justify-content-center mt-3">
                        ...
                        <button onClick={() => loginWithGoogle()} className="border-1 border border-secondary py-1 d-flex justify-content-center align-items-center">
