...
import { useLoginDialog } from "./LoginDialog.context";
import ValidatableInput from "../../components/input/ValidatableInput.component";
...
const initialInputValue: InputModel = {
    valid: false,
    value: ''
}
...
const LoginDialog = () => {
    ...
    const { hideLoginDialog , isOpen} = useLoginDialog();
                ...
                <div className="login-dialog">
                    <div className="cover-all-bg">
                        <div className="card card-body rounded-0 p-3 position-absolute translate-middle-x start-50 top-0">
                            ...
                            <div className="btn-close position-absolute end-0 top-0 m-1" onClick={() => hideLoginDialog()}></div>
                            ...
                            <div className="px-2 mt-3">
                                ...
                                <button className={`w-100 mt-3 bg-black text-white login`} onClick={() => login()}>Đăng nhập</button>
                                ...
                                <label className="text-center mt-2 text-secondary" style={{fontSize: '14px'}}>Chưa có tài khoản? <a className="act-text" href="/register">Đăng kí</a></label>
                            </div>
