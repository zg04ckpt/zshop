...
import { useLoginDialog } from "../login/LoginDialog.context";
        ...
        <div className="register row mt-4">
            ...
            <div className="card col-6 card-body rounded-0 mt-3">
                ...
                <div className="d-flex justify-content-center mt-3">
                    <button className="bg-black text-white me-2" onClick={() => register()}>Đăng kí</button>
                ...
                <label className="text-center mt-2 text-secondary" style={{fontSize: '14px'}}>Đã có tài khoản? 
                    <span className="act-text ms-1" onClick={showLoginDialog}>Đăng nhập</span></label>
            </div>
