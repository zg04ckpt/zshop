...
import { AppDispatch, endLoadingStatus, RootState, 
    setUser, startLoadingStatus, useAppContext } from "../stores";
            ...
            <div className="topbar">
                <div className="d-flex align-items-center">
                    ...
                    <div className="d-flex me-4 align-items-center ">
                        ...
                        { user && <>
                            <img src={user.avatarUrl || process.env.REACT_APP_DEFAULT_IMAGE_URL} alt="" className="avt pointer-hover" data-bs-toggle="dropdown"/>
