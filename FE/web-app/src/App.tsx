...
function App() {
  ...
  return (
    <>
      {/* Toast */}
      <ToastContainer position="top-right" autoClose={1000} hideProgressBar={false} newestOnTop limit={1} closeOnClick pauseOnHover={false} closeButton={false} rtl={false} theme="light"/>
