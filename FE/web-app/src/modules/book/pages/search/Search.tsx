...
export type SearchType = 'newest'|'top-sell';
...
const Search = () => {
    ...
    const initParamFromQuery = async () => {
        setName(params.get('k') ?? '');
        if (params.get('type')) {
                ...
                <div className="col-3">
                    <div className="d-flex flex-column">
                        ...
                        >
                            ...
                            <FormControlLabel value="soldCount-desc" control={<Radio size="small"/>} label="Bán nhiều nhất" />
