        ...
        <div className={`pagination ${prop.className}`}>
            <div className="d-flex justify-content-center">
                ...
                <ul className="pagination d-flex justify-content-center mb-0" style={{width: '322px'}}>
                    ...
                    { prop.page - 2 > 1 && <h5 className="p-0 align-content-center mx-2" style={{height: '36px'}}>. . .</h5> }
                    ...
                    { prop.page + 2 < prop.total && <h5 className="p-0 align-content-center mx-2" style={{height: '36px'}}>. . .</h5> }
